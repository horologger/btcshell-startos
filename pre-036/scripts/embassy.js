...
const setConfig1 = async (effects, input)=>{
    ...
    const depsLnd = newConfig?.implementation === "LndRestWallet" ? {
        lnd: []
    } : {};
    const depsCln = newConfig?.implementation === "CLightningWallet" ? {
        "c-lightning": []
    } : {};
...
const migration = mod3.migrations.fromMapping({}, "0.0.0");
const health = {
    "web-ui": mod4.checkWebUrl("http://btcshell.embassy:8080")
};
